...
set_input_delay -clock sys_clk_pin 5 [get_ports {btnc btnl btnu btnr btnd}]
set_output_delay -clock sys_clk_pin 5 [get_ports {led[0] led[1] led[2] led[3] led[4] led[5] led[6] led[7]}]
