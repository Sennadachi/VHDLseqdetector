...
REM
REM Generated by Vivado on Tue Dec 02 23:01:43 +0000 2025
...
echo "xvlog --incr --relax -prj assignment_vlog.prj"
call xvlog  --incr --relax -prj assignment_vlog.prj -log xvlog.log
